...
const PRODUCTS_URL = isProduction ? 'https://stuffy-backend-api-xmln.onrender.com/graphql' : 'http://localhost:5000/graphql';
const AUTH_URL = isProduction ? 'https://stuffy-auth-service-xmln.onrender.com/graphql' : 'http://localhost:5001/graphql';
